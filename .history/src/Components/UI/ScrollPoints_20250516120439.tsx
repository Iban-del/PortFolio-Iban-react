...
const ScrollPoints: React.FC<ScrollPointsIntertface> = ({
    ...
    return (
        <div className="fixed w-[100%] h-[100%] flex justify-end top-[0px] z-[-1]">
            <div className="w-[30px] flex flex justify-center items-center ">
...
const Point: React.FC<PointInterface> = ({
    ...
    const color = active? "bg-green-contrast" : "bg-green-contrast-a";

    return <div className="w-[10px] h-[10px] rounded-[90px] m-2 bg-green-contrast">
