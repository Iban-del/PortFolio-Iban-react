...
const Point: React.FC<PointInterface> = ({
    ...
    return <div className={classNames("w-[13px] h-[13px] rounded-[90px] m-2",active? "bg-green-contrast" : "bg-green-contrast-a")}>
        <div className={classNames("w-[5px] h-[5px] rounded-[90px] bg-green-contrast",active? "bg-green-contrast" : "bg-green-contrast-a")}>
