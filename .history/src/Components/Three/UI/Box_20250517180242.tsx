...
export interface BoxInterface extends MeshComponentInterface,DefaultGeometry{
    ...
    materialArgs?:MeshStandardMaterial
}
...
const Box: React.FC<BoxInterface>  = ({
    ...
    return (
        ...
        >
            ...
            <meshStandardMaterial emissive={color} emissiveIntensity={50} color={color} metalness={metalness} roughness={roughness} ></meshStandardMaterial>
        </MeshComponent>
    )
