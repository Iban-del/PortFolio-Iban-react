...
const Card = ({
    ...
    return(
        <>
            ...
            <Dialog open={showPopUp} onClose={setShowPopUp} className="relative z-10">
                <DialogBackdrop
                    transition
                ...
                <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                    ...
                    >
                        ...
                        <div className="sm:flex sm:items-start">
                            <div className="mx-auto flex size-12 shrink-0 items-center text-gray-900 justify-center rounded-full bg-gray-100 sm:mx-0 sm:size-10">
                                {popUpIcon}
                            </div>
