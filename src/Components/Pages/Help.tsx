...
const Mouse = () =>{
    return (
        <motion.div 
            className="h-[180px] w-[100px] border-1 rounded-[80px]"
            whileHover={{scale:1.1}}
        >
...
const Pad = () =>{
    return (
        <motion.div 
            className="h-[180px] w-[280px] border-1 rounded-lg "
            whileHover={{scale:1.1}}
        >
...
const PhoneHepl = () =>{
    return (
        <motion.div 
            className="h-[320px] w-[280px] border-1 rounded-lg flex items-start"
            whileTap={{alignItems:'end'}}
        >
            <motion.div 
                className="h-[180px] w-[280px] border-1 rounded-lg "
                whileHover={{scale:1.1}}
